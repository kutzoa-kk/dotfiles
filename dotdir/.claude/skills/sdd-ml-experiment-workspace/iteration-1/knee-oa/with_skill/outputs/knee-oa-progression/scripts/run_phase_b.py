"""Phase B: Regression Model Cross-Validation

Trains ordinal regression models (LightGBM, XGBoost) with GroupKFold 5-fold CV
and evaluates prediction performance on KL grade (0-4).

Gate: RMSE <= 1.0 on cross-validated OOF predictions.

Usage:
    uv run python scripts/run_phase_b.py
    uv run python scripts/run_phase_b.py model=xgboost
"""
...
def main(cfg: DictConfig) -> None:
    logger.info("=== Phase B: Regression Model Cross-Validation ===")
